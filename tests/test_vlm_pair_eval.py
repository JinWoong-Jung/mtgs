...
import vlm.eval_pair as eval_pair_module
from vlm.eval_pair import compare_results, run_evaluation
from vlm.pair_head import GraphLogitMLPControl, PairTaskBCELoss
from vlm.train_pair import save_control_checkpoint
from vlm.pair_dataset import PairAnnotationDataset
...
def test_raw_graph_predictions_use_canonical_indices_but_raw_eval_keys(tmp_path):
    ...
    _manifest(manifest)
    annotations = PairAnnotationDataset(manifest)
